            ...
            if opinions_count:
                ...
                while (url):
                    ...
                    product = {
                        ...
                        'rating_distribution' : opinions.rating.value_counts().sort_index().reindex(np.arange(0,5.5,0.5), fill_value = 0.0).to_dict(),
                    ...
                    with open(f"app/data/opinions/products.json", "w", encoding="UTF-8") as jf:
...
def download_json(product_id):
    ...
    return send_file(buffer, "text/csv", as_attachment=True)
